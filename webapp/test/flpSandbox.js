					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPUI5 BTP Fiori on CF",
									"targetURL": "#sapui5btpcf-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"sapui5btpcf-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5btpcf",
									"url": sap.ui.require.toUrl("sapui5btpcf")
								}
							}
						}
					}
